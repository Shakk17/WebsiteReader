function getE(h)
{
	switch (h)
	{
		...
		case 'szuf.magyarorszag.hu': return ['cookies_ok=1'];
		...
		case 'milkywire.com': return ['cookie_consent=true'];
		...
		case 'dehn.de': return ['cookie-agreed=1', 'cookie-processed=ck_1:true%2Cck_2:true'];
		...
		case 'backmarket.be': return ['BM_Banner_Dismissed=true'];
