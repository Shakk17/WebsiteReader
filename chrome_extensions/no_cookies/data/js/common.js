(function() {
	var searchGroups = [
		...
		#cookie-control-modal.show .btn-primary,\
		.modal.cookie.show #Row1_Column1_Cell1_CookieSettings_AdvancedSaveAccept,\
		#cookie-control-modal.in .btn-primary,\
		...
		.pum[data-popmake*="cookie-notice"] .pum-close,\
		.pum[data-popmake*="cookie-banner"] .pum-close,\
		.pum[data-popmake*="cookie-pop"] .pum-close,\
		.pum[data-popmake*="cookies-pop"] .pum-close,\
		.pum[data-popmake*="informativa-cookie"] .pum-close,\
		.pum[data-popmake*="assenso-cookie"] .pum-close,\
		.pum[data-popmake*="pryvatnast"] .pum-close,\
		.modal #consentButton,\
		...
		div[class^="sp_veil"] + div[id^="sp_message"] #sp-tabindex-focus + div div[class^="sp_choices"] button[aria-label]:first-child + button,\	#privacyPolicyInfo.active #acceptPrivacyPolicy,\
		...
		.site .content input[name="csrf_token"] ~ .approve-btn,\
		...
		button.cookie-banner__btn-accept,\
		...
		#cookie-control-modal.in .btn-success,\
		...
		#cookie-control-modal.show .btn-success,\
		...
		body[class*="tiki"] #cookie_consent_div:not([style*="none"]) #cookie_consent_checkbox,\
		body[class*="tiki"] #cookie_consent_div:not([style*="none"]) #cookie_consent_button,\
